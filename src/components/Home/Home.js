  ...
  return (
    <div className={Style["home-section"]}>
      ...
      <div className={Style["product-section"]}>
        ...
        <Product
          id="90829342"
          title="Samsung T35F 60.96 cm (24 Inches) Full HD IPS Screen Monitor"
          price={1094.98}
          rating={4}
          image="https://images.unsplash.com/photo-1551645120-d70bfe84c826?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80"
        />
      </div>
    </div>
  );
